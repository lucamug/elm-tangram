...
var _lucamug$elm_tangram$Colors$stringToColor = function (string) {
	return A2(
		_elm_lang$core$Result$withDefault,
		_elm_lang$core$Color$black,
		_eskimoblood$elm_color_extra$Color_Convert$hexToColor(string));
};
var _lucamug$elm_tangram$Colors$colorToString = function (color) {
	var hex = _eskimoblood$elm_color_extra$Color_Convert$colorToHex(color);
	var $short = (_elm_lang$core$Native_Utils.eq(
		A3(_elm_lang$core$String$slice, 1, 2, hex),
		A3(_elm_lang$core$String$slice, 2, 3, hex)) && (_elm_lang$core$Native_Utils.eq(
		A3(_elm_lang$core$String$slice, 3, 4, hex),
		A3(_elm_lang$core$String$slice, 4, 5, hex)) && _elm_lang$core$Native_Utils.eq(
		A3(_elm_lang$core$String$slice, 5, 6, hex),
		A3(_elm_lang$core$String$slice, 6, 7, hex)))) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'#',
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A3(_elm_lang$core$String$slice, 3, 4, hex),
				A3(_elm_lang$core$String$slice, 5, 6, hex)))) : hex;
	return $short;
};
var _lucamug$elm_tangram$Colors$colorToNakedString = function (color) {
	return A2(
		_elm_lang$core$String$dropLeft,
		1,
		_lucamug$elm_tangram$Colors$colorToString(color));
};
var _lucamug$elm_tangram$Colors$canvasGray = A3(_elm_lang$core$Color$rgb, 221, 221, 221);
var _lucamug$elm_tangram$Colors$darkGray = A3(_elm_lang$core$Color$rgb, 51, 51, 51);
var _lucamug$elm_tangram$Colors$gray = A3(_elm_lang$core$Color$rgb, 153, 153, 153);
var _lucamug$elm_tangram$Colors$white = _elm_lang$core$Color$white;
var _lucamug$elm_tangram$Colors$red = A3(_elm_lang$core$Color$rgb, 255, 0, 0);
var _lucamug$elm_tangram$Colors$elmGray = A3(_elm_lang$core$Color$rgb, 90, 99, 120);
var _lucamug$elm_tangram$Colors$elmOrange = A3(_elm_lang$core$Color$rgb, 239, 165, 0);
var _lucamug$elm_tangram$Colors$elmTurquoise = A3(_elm_lang$core$Color$rgb, 96, 181, 204);
var _lucamug$elm_tangram$Colors$elmGreen = A3(_elm_lang$core$Color$rgb, 141, 215, 55);
var _lucamug$elm_tangram$Colors$black = A3(_elm_lang$core$Color$rgb, 0, 0, 0);

var _lucamug$elm_tangram$Piece_Types$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _lucamug$elm_tangram$Piece_Types$Context = F2(
	function (a, b) {
		return {shift: a, windowSize: b};
	});
var _lucamug$elm_tangram$Piece_Types$Rotating = function (a) {
	return {ctor: 'Rotating', _0: a};
};
var _lucamug$elm_tangram$Piece_Types$Dragging = function (a) {
	return {ctor: 'Dragging', _0: a};
};
var _lucamug$elm_tangram$Piece_Types$DragEnd = function (a) {
	return {ctor: 'DragEnd', _0: a};
};
var _lucamug$elm_tangram$Piece_Types$DragAt = function (a) {
	return {ctor: 'DragAt', _0: a};
};
var _lucamug$elm_tangram$Piece_Types$DragStart = function (a) {
	return {ctor: 'DragStart', _0: a};
};
var _lucamug$elm_tangram$Piece_Types$ParallelogramInverted = F2(
	function (a, b) {
		return {ctor: 'ParallelogramInverted', _0: a, _1: b};
	});
var _lucamug$elm_tangram$Piece_Types$Parallelogram = F2(
	function (a, b) {
		return {ctor: 'Parallelogram', _0: a, _1: b};
	});
var _lucamug$elm_tangram$Piece_Types$Square = F2(
	function (a, b) {
		return {ctor: 'Square', _0: a, _1: b};
	});
var _lucamug$elm_tangram$Piece_Types$Triangle = F2(
	function (a, b) {
		return {ctor: 'Triangle', _0: a, _1: b};
	});

var _lucamug$elm_tangram$Piece_Model$distance = F2(
	function (p1, p2) {
		return _elm_lang$core$Basics$sqrt(
			Math.pow(
				_elm_lang$core$Basics$toFloat(p1.x - p2.x),
				2) + Math.pow(
				_elm_lang$core$Basics$toFloat(p1.y - p2.y),
				2));
	});
var _lucamug$elm_tangram$Piece_Model$move = F2(
	function (_p0, model) {
		var _p1 = _p0;
		var newY = model.position.y + _elm_lang$core$Basics$round(_p1._1);
		var newX = model.position.x + _elm_lang$core$Basics$round(_p1._0);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				position: A2(_lucamug$elm_tangram$Piece_Types$Position, newX, newY)
			});
	});
var _lucamug$elm_tangram$Piece_Model$subscriptions = function (model) {
	var _p2 = model.drag;
	if (_p2.ctor === 'Nothing') {
		return _elm_lang$core$Platform_Sub$none;
	} else {
		return _elm_lang$core$Platform_Sub$batch(
			{
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_lucamug$elm_tangram$Piece_Types$DragAt),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_lucamug$elm_tangram$Piece_Types$DragEnd),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _lucamug$elm_tangram$Piece_Model$vectorDiff = F2(
	function (v1, v2) {
		return {x: v2.x - v1.x, y: v2.y - v1.y};
	});
var _lucamug$elm_tangram$Piece_Model$vectorAngle = function (v) {
	return A2(
		_elm_lang$core$Basics$atan2,
		_elm_lang$core$Basics$toFloat(v.x),
		_elm_lang$core$Basics$toFloat(v.y));
};
var _lucamug$elm_tangram$Piece_Model$relativeRotation = F3(
	function (start, sample, current) {
		var currentAngle = _lucamug$elm_tangram$Piece_Model$vectorAngle(
			A2(_lucamug$elm_tangram$Piece_Model$vectorDiff, current, start));
		var sampleAngle = _lucamug$elm_tangram$Piece_Model$vectorAngle(
			A2(_lucamug$elm_tangram$Piece_Model$vectorDiff, sample, start));
		return currentAngle - sampleAngle;
	});
var _lucamug$elm_tangram$Piece_Model$getRotation = function (_p3) {
	var _p4 = _p3;
	var _p7 = _p4.rotation;
	var _p5 = _p4.drag;
	if ((_p5.ctor === 'Just') && (_p5._0.ctor === 'Rotating')) {
		var _p6 = _p5._0._0.sample;
		if (_p6.ctor === 'Just') {
			return _p7 - A3(_lucamug$elm_tangram$Piece_Model$relativeRotation, _p4.position, _p6._0, _p5._0._0.current);
		} else {
			return _p7;
		}
	} else {
...
var _lucamug$elm_tangram$Piece_Model$rotating = function (model) {
	var _p8 = model.drag;
	if ((_p8.ctor === 'Just') && (_p8._0.ctor === 'Rotating')) {
		return true;
	} else {
		return false;
	}
};
var _lucamug$elm_tangram$Piece_Model$getPosition = function (_p9) {
	var _p10 = _p9;
	var _p14 = _p10.position;
	var _p11 = _p10.drag;
	if ((_p11.ctor === 'Just') && (_p11._0.ctor === 'Dragging')) {
		var _p13 = _p11._0._0.start;
		var _p12 = _p11._0._0.current;
		return A2(_lucamug$elm_tangram$Piece_Types$Position, (_p14.x + _p12.x) - _p13.x, (_p14.y + _p12.y) - _p13.y);
	} else {
		return _p14;
	}
};
var _lucamug$elm_tangram$Piece_Model$init = F5(
	function (shape, position, rad, strokeOffset, strokeColor) {
		return {
			shape: shape,
			position: position,
			rotation: rad,
			drag: _elm_lang$core$Maybe$Nothing,
			origin: A2(_lucamug$elm_tangram$Piece_Types$Position, 0, 0),
			pieceStrokeOffset: strokeOffset,
			pieceStrokeColor: strokeColor
		};
	});
var _lucamug$elm_tangram$Piece_Model$normalizeAngle = function (angle) {
	normalizeAngle:
	while (true) {
		if (_elm_lang$core$Native_Utils.cmp(angle, 2 * _elm_lang$core$Basics$pi) > -1) {
			var _v8 = angle - (2 * _elm_lang$core$Basics$pi);
			angle = _v8;
			continue normalizeAngle;
		} else {
			if (_elm_lang$core$Native_Utils.cmp(angle, 0) < 0) {
				var _v9 = angle + (2 * _elm_lang$core$Basics$pi);
				angle = _v9;
				continue normalizeAngle;
			} else {
				return angle;
...
var _lucamug$elm_tangram$Piece_Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {shape: a, position: b, rotation: c, drag: d, origin: e, pieceStrokeOffset: f, pieceStrokeColor: g};
	});

var _lucamug$elm_tangram$Tangram_Types$ConfString = F5(
	function (a, b, c, d, e) {
		return {id: a, strokeOffset: b, strokeColor: c, canvasColor: d, colorCombination: e};
	});
var _lucamug$elm_tangram$Tangram_Types$PieceString = F4(
	function (a, b, c, d) {
		return {id: a, x: b, y: c, deg: d};
	});
var _lucamug$elm_tangram$Tangram_Types$Piece = F4(
	function (a, b, c, d) {
		return {id: a, x: b, y: c, deg: d};
	});
var _lucamug$elm_tangram$Tangram_Types$Structure = F2(
	function (a, b) {
		return {conf: a, pieces: b};
	});
var _lucamug$elm_tangram$Tangram_Types$Conf = F5(
	function (a, b, c, d, e) {
		return {id: a, strokeOffset: b, strokeColor: c, canvasColor: d, colorCombination: e};
	});
var _lucamug$elm_tangram$Tangram_Types$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _lucamug$elm_tangram$Tangram_Types$Rotating = function (a) {
	return {ctor: 'Rotating', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$Dragging = function (a) {
	return {ctor: 'Dragging', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$Rainbow = {ctor: 'Rainbow'};
var _lucamug$elm_tangram$Tangram_Types$Color = function (a) {
	return {ctor: 'Color', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$Elm = {ctor: 'Elm'};
var _lucamug$elm_tangram$Tangram_Types$MousePos = function (a) {
	return {ctor: 'MousePos', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$ChangeLocationAndToggle = function (a) {
	return {ctor: 'ChangeLocationAndToggle', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$Forward = {ctor: 'Forward'};
var _lucamug$elm_tangram$Tangram_Types$Back = {ctor: 'Back'};
var _lucamug$elm_tangram$Tangram_Types$NoOp = {ctor: 'NoOp'};
var _lucamug$elm_tangram$Tangram_Types$RectDragEnd = function (a) {
	return {ctor: 'RectDragEnd', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$RectDragAt = function (a) {
	return {ctor: 'RectDragAt', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$RectDragStart = function (a) {
	return {ctor: 'RectDragStart', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$MoveToOrigin = {ctor: 'MoveToOrigin'};
var _lucamug$elm_tangram$Tangram_Types$ChangeLocation = function (a) {
	return {ctor: 'ChangeLocation', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$ChangeAspect = F4(
	function (a, b, c, d) {
		return {ctor: 'ChangeAspect', _0: a, _1: b, _2: c, _3: d};
	});
var _lucamug$elm_tangram$Tangram_Types$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$WindowSize = function (a) {
	return {ctor: 'WindowSize', _0: a};
};
var _lucamug$elm_tangram$Tangram_Types$PieceMsg = F2(
	function (a, b) {
		return {ctor: 'PieceMsg', _0: a, _1: b};
	});

var _lucamug$elm_tangram$Tangram_Model$degToRad = function (deg) {
	return (deg / 180) * _elm_lang$core$Basics$pi;
};
var _lucamug$elm_tangram$Tangram_Model$radToDeg = function (rad) {
	var deg = (rad * 180) / _elm_lang$core$Basics$pi;
	var normalizedDeg = (_elm_lang$core$Native_Utils.cmp(deg, 360) > -1) ? (deg - 360) : ((_elm_lang$core$Native_Utils.cmp(deg, 0) < 0) ? (deg + 360) : deg);
	return normalizedDeg;
};
var _lucamug$elm_tangram$Tangram_Model$subscriptions = function (model) {
	var mouse = function () {
		var _p0 = model.rectDrag;
		if (_p0.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return model.pieceDragging ? {ctor: '[]'} : {
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$moves(_lucamug$elm_tangram$Tangram_Types$RectDragAt),
				_1: {
					ctor: '::',
					_0: _elm_lang$mouse$Mouse$ups(_lucamug$elm_tangram$Tangram_Types$RectDragEnd),
					_1: {ctor: '[]'}
				}
			};
		}
	}();
	var keyUps = _elm_lang$keyboard$Keyboard$ups(_lucamug$elm_tangram$Tangram_Types$KeyUp);
	var keyDowns = _elm_lang$keyboard$Keyboard$downs(_lucamug$elm_tangram$Tangram_Types$KeyDown);
	var reSize = _elm_lang$window$Window$resizes(_lucamug$elm_tangram$Tangram_Types$WindowSize);
	var mapSubs = function (_p1) {
		var _p2 = _p1;
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_lucamug$elm_tangram$Tangram_Types$PieceMsg(_p2._0),
			_lucamug$elm_tangram$Piece_Model$subscriptions(_p2._1));
	};
	return _elm_lang$core$Platform_Sub$batch(
		A2(
			_elm_lang$core$Basics_ops['++'],
...
var _lucamug$elm_tangram$Tangram_Model$colorCombinations = function (combination) {
	var _p3 = combination;
	switch (_p3.ctor) {
		case 'Elm':
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '△', _1: _lucamug$elm_tangram$Colors$elmTurquoise},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '▷', _1: _lucamug$elm_tangram$Colors$elmGray},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: '◹', _1: _lucamug$elm_tangram$Colors$elmTurquoise},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: '◁', _1: _lucamug$elm_tangram$Colors$elmOrange},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '▽', _1: _lucamug$elm_tangram$Colors$elmOrange},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: '▢', _1: _lucamug$elm_tangram$Colors$elmGreen},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: '▱', _1: _lucamug$elm_tangram$Colors$elmGreen},
										_1: {
		...
		case 'Rainbow':
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '△', _1: _elm_lang$core$Color$lightRed},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '▷', _1: _elm_lang$core$Color$lightOrange},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: '◹', _1: _elm_lang$core$Color$lightBlue},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: '◁', _1: _elm_lang$core$Color$lightGreen},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '▽', _1: _elm_lang$core$Color$white},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: '▢', _1: _elm_lang$core$Color$lightPurple},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: '▱', _1: _elm_lang$core$Color$lightYellow},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: '▰', _1: _elm_lang$core$Color$lightYellow},
											_1: {ctor: '[]'}
...
var _lucamug$elm_tangram$Tangram_Model$pieceColor = F2(
	function (pieceId, combination) {
		return _elm_lang$core$Tuple$second(
			A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '_Tuple2', _0: '', _1: _lucamug$elm_tangram$Colors$gray},
				_elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (_p5) {
							var _p6 = _p5;
							return _elm_lang$core$Native_Utils.eq(pieceId, _p6._0);
						},
						_lucamug$elm_tangram$Tangram_Model$colorCombinations(combination)))));
	});
var _lucamug$elm_tangram$Tangram_Model$pieceShape = F2(
	function (id, color) {
		var _p7 = id;
		switch (_p7) {
			case '△':
				return A2(_lucamug$elm_tangram$Piece_Types$Triangle, color, 100.0);
			case '▷':
				return A2(_lucamug$elm_tangram$Piece_Types$Triangle, color, 100.0);
			case '◹':
				return A2(
					_lucamug$elm_tangram$Piece_Types$Triangle,
					color,
					100.0 / _elm_lang$core$Basics$sqrt(2));
			case '◁':
				return A2(_lucamug$elm_tangram$Piece_Types$Triangle, color, 100.0 / 2);
			case '▽':
				return A2(_lucamug$elm_tangram$Piece_Types$Triangle, color, 100.0 / 2);
			case '▢':
				return A2(_lucamug$elm_tangram$Piece_Types$Square, color, 100.0);
			case '▱':
				return A2(_lucamug$elm_tangram$Piece_Types$Parallelogram, color, 100.0);
			case '▰':
				return A2(_lucamug$elm_tangram$Piece_Types$ParallelogramInverted, color, 100.0);
			default:
				return A2(_lucamug$elm_tangram$Piece_Types$Square, _lucamug$elm_tangram$Colors$black, 50.0);
		}
	});
var _lucamug$elm_tangram$Tangram_Model$fromPieceOfStringsToPiece = function (piece) {
	...
	return {
		...
		x: toInt(piece.x),
		y: toInt(piece.y),
		deg: _lucamug$elm_tangram$Tangram_Model$degToRad(
			_elm_lang$core$Basics$toFloat(
				toInt(piece.deg)))
	};
};
var _lucamug$elm_tangram$Tangram_Model$stringToColorCombination = function (v) {
	var _p8 = v;
	switch (_p8) {
		case '🌈':
			return _lucamug$elm_tangram$Tangram_Types$Rainbow;
		case '🌳':
			return _lucamug$elm_tangram$Tangram_Types$Elm;
		default:
			return _lucamug$elm_tangram$Tangram_Types$Color(
				_lucamug$elm_tangram$Colors$stringToColor(
					A2(_elm_lang$core$Basics_ops['++'], '#', v)));
	}
};
var _lucamug$elm_tangram$Tangram_Model$confStringToConf = function (conf) {
	var toInt = function (a) {
		return A2(
			_elm_lang$core$Result$withDefault,
			0,
	...
	return {
		id: conf.id,
		strokeOffset: _elm_lang$core$Basics$toFloat(
			toInt(conf.strokeOffset)),
		strokeColor: _lucamug$elm_tangram$Colors$stringToColor(
			A2(_elm_lang$core$Basics_ops['++'], '#', conf.strokeColor)),
		canvasColor: _lucamug$elm_tangram$Colors$stringToColor(
			A2(_elm_lang$core$Basics_ops['++'], '#', conf.canvasColor)),
		colorCombination: _lucamug$elm_tangram$Tangram_Model$stringToColorCombination(conf.colorCombination)
	};
};
var _lucamug$elm_tangram$Tangram_Model$pieceGenerator = F2(
	function (confString, pieceString) {
		var piece = _lucamug$elm_tangram$Tangram_Model$fromPieceOfStringsToPiece(pieceString);
		var position = A2(_lucamug$elm_tangram$Piece_Types$Position, piece.x, piece.y);
		var conf = _lucamug$elm_tangram$Tangram_Model$confStringToConf(confString);
		var color = A2(_lucamug$elm_tangram$Tangram_Model$pieceColor, piece.id, conf.colorCombination);
		var shape = A2(_lucamug$elm_tangram$Tangram_Model$pieceShape, piece.id, color);
		return {
			ctor: '_Tuple2',
			_0: piece.id,
			_1: A5(_lucamug$elm_tangram$Piece_Model$init, shape, position, piece.deg, conf.strokeOffset, conf.strokeColor)
		};
	});
var _lucamug$elm_tangram$Tangram_Model$colorCombinationToString = function (v) {
	var _p9 = v;
	switch (_p9.ctor) {
		case 'Color':
			return _lucamug$elm_tangram$Colors$colorToNakedString(_p9._0);
		case 'Rainbow':
			return '🌈';
		default:
			return '🌳';
...
var _lucamug$elm_tangram$Tangram_Model$confToConfString = function (confString) {
	return {
		id: confString.id,
		strokeOffset: _elm_lang$core$Basics$toString(
			_elm_lang$core$Basics$floor(confString.strokeOffset)),
		strokeColor: _lucamug$elm_tangram$Colors$colorToNakedString(confString.strokeColor),
		canvasColor: _lucamug$elm_tangram$Colors$colorToNakedString(confString.canvasColor),
		colorCombination: _lucamug$elm_tangram$Tangram_Model$colorCombinationToString(confString.colorCombination)
	};
};
var _lucamug$elm_tangram$Tangram_Model$modelToConf = function (model) {
	return {
		ctor: '::',
		_0: '☞',
		_1: {
			ctor: '::',
			_0: _elm_lang$core$Basics$toString(model.strokeOffset),
			_1: {
				ctor: '::',
				_0: _lucamug$elm_tangram$Colors$colorToNakedString(model.strokeColor),
				_1: {
					ctor: '::',
					_0: _lucamug$elm_tangram$Colors$colorToNakedString(model.canvasColor),
					_1: {
						ctor: '::',
						_0: _lucamug$elm_tangram$Tangram_Model$colorCombinationToString(model.colorCombination),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _lucamug$elm_tangram$Tangram_Model$separators = {betweenData: ',', betweenPieces: '_'};
var _lucamug$elm_tangram$Tangram_Model$encodePiece = F3(
	function (pieceId, position, rotation) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			pieceId,
			A2(
				_elm_lang$core$Basics_ops['++'],
				_lucamug$elm_tangram$Tangram_Model$separators.betweenData,
				A2(
					_elm_lang$core$String$join,
					_lucamug$elm_tangram$Tangram_Model$separators.betweenData,
					{
						ctor: '::',
						_0: _elm_lang$core$Basics$toString(position.x),
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Basics$toString(position.y),
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Basics$toString(
									_elm_lang$core$Basics$round(
										_lucamug$elm_tangram$Tangram_Model$radToDeg(rotation))),
								_1: {ctor: '[]'}
							}
						}
					})));
	});
var _lucamug$elm_tangram$Tangram_Model$modelToPath = function (model) {
	return A2(
		_elm_lang$core$String$join,
		_lucamug$elm_tangram$Tangram_Model$separators.betweenPieces,
		A2(
			F2(
				function (x, y) {
					return {ctor: '::', _0: x, _1: y};
			...
			A2(
				_elm_lang$core$String$join,
				_lucamug$elm_tangram$Tangram_Model$separators.betweenData,
				_lucamug$elm_tangram$Tangram_Model$modelToConf(model)),
			A2(
				_elm_lang$core$List$map,
				function (_p10) {
					var _p11 = _p10;
					return A3(_lucamug$elm_tangram$Tangram_Model$encodePiece, _p11._0, _p11._1.position, _p11._1.rotation);
				},
				model.pieces)));
};
var _lucamug$elm_tangram$Tangram_Model$modelToPathSorted = F2(
			...
			A2(
				...
				_elm_lang$core$List$sort(
					A2(
						...
						function (_p12) {
							var _p13 = _p12;
							return A3(_lucamug$elm_tangram$Tangram_Model$encodePiece, _p13._0, _p13._1.position, _p13._1.rotation);
						},
						pieces))));
	});
var _lucamug$elm_tangram$Tangram_Model$startingCanvasColor = _lucamug$elm_tangram$Colors$darkGray;
var _lucamug$elm_tangram$Tangram_Model$startingPath = A2(
	_elm_lang$core$Basics_ops['++'],
	'/☞,3,',
	A2(
		_elm_lang$core$Basics_ops['++'],
		_lucamug$elm_tangram$Colors$colorToNakedString(_lucamug$elm_tangram$Tangram_Model$startingCanvasColor),
		A2(
			_elm_lang$core$Basics_ops['++'],
			',',
			A2(
...
var _lucamug$elm_tangram$Tangram_Model$structureToPath = function (structure) {
	var pieces = A2(
		_elm_lang$core$String$join,
		_lucamug$elm_tangram$Tangram_Model$separators.betweenPieces,
		A2(
	...
	var conf = A2(
		...
		{
			ctor: '::',
			_0: structure.conf.id,
			_1: {
				ctor: '::',
				_0: structure.conf.strokeOffset,
				_1: {
					ctor: '::',
					_0: structure.conf.strokeColor,
					_1: {
						ctor: '::',
						_0: structure.conf.canvasColor,
						_1: {
							ctor: '::',
							_0: structure.conf.colorCombination,
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return A2(
		_elm_lang$core$Basics_ops['++'],
		conf,
		A2(_elm_lang$core$Basics_ops['++'], _lucamug$elm_tangram$Tangram_Model$separators.betweenPieces, pieces));
};
var _lucamug$elm_tangram$Tangram_Model$pathToStructure = function (path) {
	var allSplit = A2(
		_elm_lang$core$List$map,
		function (piece) {
			return A2(_elm_lang$core$String$split, _lucamug$elm_tangram$Tangram_Model$separators.betweenData, piece);
		},
		A2(_elm_lang$core$String$split, _lucamug$elm_tangram$Tangram_Model$separators.betweenPieces, path));
	...
	var piecesListList = tail(allSplit);
	...
	var pieces = A2(
		...
		piecesListList);
	var headList = function (list) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			_elm_lang$core$List$head(list));
	};
	var confList = headList(allSplit);
	var conf = {
		id: head(confList),
		strokeOffset: head(
			tail(confList)),
		...
		canvasColor: head(
			tail(
				tail(
					tail(confList)))),
		colorCombination: head(
			tail(
				tail(
					tail(
						tail(confList)))))
	};
	return {conf: conf, pieces: pieces};
};
var _lucamug$elm_tangram$Tangram_Model$modelToStructure = function (model) {
	return _lucamug$elm_tangram$Tangram_Model$pathToStructure(
		_lucamug$elm_tangram$Tangram_Model$modelToPath(model));
};
var _lucamug$elm_tangram$Tangram_Model$pathToPieces = function (path) {
	var structure = _lucamug$elm_tangram$Tangram_Model$pathToStructure(path);
	return A2(
		_elm_lang$core$List$map,
		function (piece) {
			return A2(_lucamug$elm_tangram$Tangram_Model$pieceGenerator, structure.conf, piece);
		},
		structure.pieces);
};
var _lucamug$elm_tangram$Tangram_Model$pathToConfOfString = function (path) {
	var structure = _lucamug$elm_tangram$Tangram_Model$pathToStructure(path);
	return {id: structure.conf.id, strokeOffset: structure.conf.strokeOffset, strokeColor: structure.conf.strokeColor, canvasColor: structure.conf.canvasColor, colorCombination: structure.conf.colorCombination};
};
var _lucamug$elm_tangram$Tangram_Model$pathToConf = function (path) {
	return _lucamug$elm_tangram$Tangram_Model$confStringToConf(
		_lucamug$elm_tangram$Tangram_Model$pathToConfOfString(path));
};
var _lucamug$elm_tangram$Tangram_Model$init = function (path) {
	var conf = _lucamug$elm_tangram$Tangram_Model$pathToConf(path);
	return {
		ctor: '_Tuple2',
		_0: {
			pieces: _lucamug$elm_tangram$Tangram_Model$pathToPieces(path),
			...
			windowSize: A2(_elm_lang$window$Window$Size, 600, 600),
			keyShiftDown: false,
			keyCommandDown: false,
			keyControlDown: false,
			name: 'Default',
			errors: {ctor: '[]'},
			rectDrag: _elm_lang$core$Maybe$Nothing,
			pieceDragging: false,
			counter: 0,
			pointer: A2(_elm_lang$mouse$Mouse$Position, 0, 0)
		},
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Task$perform, _lucamug$elm_tangram$Tangram_Types$WindowSize, _elm_lang$window$Window$size),
				_1: {ctor: '[]'}
			})
	};
};
var _lucamug$elm_tangram$Tangram_Model$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {pieces: a, windowSize: b, keyShiftDown: c, keyCommandDown: d, keyControlDown: e, strokeOffset: f, strokeColor: g, canvasColor: h, colorCombination: i, name: j, errors: k, rectDrag: l, pieceDragging: m, counter: n, pointer: o};
														};
													};
												};
											};
...
var _lucamug$elm_tangram$Piece_Update$restrictTo = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
		return {
...
var _lucamug$elm_tangram$Piece_Update$positionDiff = F2(
	function (origin, pos) {
		return A2(_lucamug$elm_tangram$Piece_Types$Position, pos.x - origin.x, pos.y - origin.y);
	});
var _lucamug$elm_tangram$Piece_Update$updateHelp = F3(
	function (context, msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'DragStart':
				var _p5 = _p4._0._1;
				var svgOrigin = A2(_lucamug$elm_tangram$Piece_Update$positionDiff, _p5, _p4._0._0);
				return context.shift ? _elm_lang$core$Native_Utils.update(
					model,
					{
						drag: _elm_lang$core$Maybe$Just(
							_lucamug$elm_tangram$Piece_Types$Rotating(
					...
					{
						drag: _elm_lang$core$Maybe$Just(
							_lucamug$elm_tangram$Piece_Types$Dragging(
								{start: _p5, current: _p5})),
						origin: svgOrigin
					});
			case 'DragAt':
				var xySvg = A2(_lucamug$elm_tangram$Piece_Update$positionDiff, model.origin, _p4._0);
				var drag = function () {
					var _p6 = model.drag;
					if (_p6.ctor === 'Nothing') {
						...
						if (_p6._0.ctor === 'Dragging') {
							...
							var sample = (_elm_lang$core$Native_Utils.eq(_p7.sample, _elm_lang$core$Maybe$Nothing) && (_elm_lang$core$Native_Utils.cmp(
								A2(_lucamug$elm_tangram$Piece_Model$distance, _p7.start, xySvg),
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					...
					{
						position: A2(
							_lucamug$elm_tangram$Piece_Update$restrictTo,
							context.windowSize,
							_lucamug$elm_tangram$Piece_Model$getPosition(model)),
						rotation: _lucamug$elm_tangram$Piece_Model$getRotation(model),
						drag: _elm_lang$core$Maybe$Nothing
					});
		}
	});
var _lucamug$elm_tangram$Piece_Update$update = F3(
	function (context, msg, model) {
		var model_ = A3(_lucamug$elm_tangram$Piece_Update$updateHelp, context, msg, model);
		return {ctor: '_Tuple2', _0: model_, _1: _elm_lang$core$Platform_Cmd$none};
	});

var _lucamug$elm_tangram$Piece_View$pointsToString = function (list) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		A2(
...
var _lucamug$elm_tangram$Piece_View$translatePoint = F2(
	function (_p3, _p2) {
		var _p4 = _p3;
		var _p5 = _p2;
		return {ctor: '_Tuple2', _0: _p5._0 + _p4._0, _1: _p5._1 + _p4._1};
	});
var _lucamug$elm_tangram$Piece_View$scalePoint = F2(
	function (factor, _p6) {
		var _p7 = _p6;
		return {ctor: '_Tuple2', _0: _p7._0 * factor, _1: _p7._1 * factor};
	});
var _lucamug$elm_tangram$Piece_View$rotatePoint = F2(
	function (angle, _p8) {
		var _p9 = _p8;
		var _p11 = _p9._1;
		var _p10 = _p9._0;
		var y_ = (_p10 * _elm_lang$core$Basics$sin(angle)) + (_p11 * _elm_lang$core$Basics$cos(angle));
		var x_ = (_p10 * _elm_lang$core$Basics$cos(angle)) - (_p11 * _elm_lang$core$Basics$sin(angle));
		return {ctor: '_Tuple2', _0: x_, _1: y_};
	});
var _lucamug$elm_tangram$Piece_View$polygon2 = F5(
	function (model, vertices, color, _p12, drag) {
		var _p13 = _p12;
		var cursorVal = function () {
			var _p14 = drag;
			if (_p14.ctor === 'Just') {
				if (_p14._0.ctor === 'Dragging') {
					return 'move';
				} else {
					return 'crosshair';
				}
				...
				_0: A2(
					_elm_lang$svg$Svg$polygon,
					{
						...
						_0: _elm_lang$svg$Svg_Attributes$points(
							_lucamug$elm_tangram$Piece_View$pointsToString(vertices)),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: _elm_lang$svg$Svg_Attributes$stroke(
									_lucamug$elm_tangram$Colors$colorToString(model.pieceStrokeColor)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$strokeWidth(
										_elm_lang$core$Basics$toString(model.pieceStrokeOffset * 2)),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$strokeLinejoin('round'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$cursor(cursorVal),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _lucamug$elm_tangram$Piece_View$paraPointsInverted = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: -0.75, _1: 0.25},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 0.25, _1: 0.25},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 0.75, _1: -0.25},
			_1: {
...
var _lucamug$elm_tangram$Piece_View$paraPoints = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0.25, _1: -0.25},
	_1: {
		ctor: '::',
...
var _lucamug$elm_tangram$Piece_View$squarePoints = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0, _1: -0.5},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 0.5, _1: 0},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 0, _1: 0.5},
			_1: {
...
var _lucamug$elm_tangram$Piece_View$trianglePoints = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 0, _1: -0.5},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 1, _1: 0.5},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: -1, _1: 0.5},
			_1: {ctor: '[]'}
...
var _lucamug$elm_tangram$Piece_View$shapeInfo = function (shape) {
	var _p15 = shape;
	switch (_p15.ctor) {
		case 'Triangle':
			return {points: _lucamug$elm_tangram$Piece_View$trianglePoints, color: _p15._0, scale: _p15._1};
		case 'Square':
			return {points: _lucamug$elm_tangram$Piece_View$squarePoints, color: _p15._0, scale: _p15._1};
		case 'Parallelogram':
			return {points: _lucamug$elm_tangram$Piece_View$paraPoints, color: _p15._0, scale: _p15._1};
		default:
			return {points: _lucamug$elm_tangram$Piece_View$paraPointsInverted, color: _p15._0, scale: _p15._1};
	}
};
var _lucamug$elm_tangram$Piece_View$offsetPosition = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
	...
	A3(
		_elm_lang$core$Json_Decode$map2,
		_lucamug$elm_tangram$Piece_Types$Position,
		A2(_elm_lang$core$Json_Decode$field, 'pageX', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode$field, 'pageY', _elm_lang$core$Json_Decode$int)),
	A3(
		_elm_lang$core$Json_Decode$map2,
...
var _lucamug$elm_tangram$Piece_View$boundingBox = F2(
	function (offset, vertices) {
		var _p16 = _elm_lang$core$List$unzip(vertices);
		var xs = _p16._0;
		var ys = _p16._1;
		var minx = A2(
			_elm_lang$core$Maybe$withDefault,
		...
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: minx - offset, _1: miny - offset},
			_1: {ctor: '_Tuple2', _0: maxx + offset, _1: maxy + offset}
		};
	});
var _lucamug$elm_tangram$Piece_View$normalizeVertices = F2(
	function (offset, vertices) {
		var _p17 = A2(_lucamug$elm_tangram$Piece_View$boundingBox, offset, vertices);
		var minx = _p17._0._0;
		var miny = _p17._0._1;
		var maxx = _p17._1._0;
		var maxy = _p17._1._1;
		var scale = A2(_elm_lang$core$Basics$max, maxx - minx, maxy - miny);
		return A2(
			_elm_lang$core$List$map,
			_lucamug$elm_tangram$Piece_View$scalePoint(1 / scale),
			A2(
				_elm_lang$core$List$map,
				_lucamug$elm_tangram$Piece_View$translatePoint(
					{ctor: '_Tuple2', _0: 0 - minx, _1: 0 - miny}),
				vertices));
	});
var _lucamug$elm_tangram$Piece_View$vertices = function (model) {
	var realRotation = _lucamug$elm_tangram$Piece_Model$getRotation(model);
	var realPosition = _lucamug$elm_tangram$Piece_Model$getPosition(model);
	var _p18 = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toFloat(realPosition.x),
		_1: _elm_lang$core$Basics$toFloat(realPosition.y)
	};
	var position = _p18;
	var px = _p18._0;
	var py = _p18._1;
	var _p19 = _lucamug$elm_tangram$Piece_View$shapeInfo(model.shape);
	var points = _p19.points;
	var scale = _p19.scale;
	return A2(
		_elm_lang$core$List$map,
		function (_p20) {
			return A2(
				...
				position,
				A2(
					_lucamug$elm_tangram$Piece_View$rotatePoint,
					realRotation,
					A2(_lucamug$elm_tangram$Piece_View$scalePoint, scale, _p20)));
		},
		points);
};
var _lucamug$elm_tangram$Piece_View$view = function (model) {
	var _p21 = _lucamug$elm_tangram$Piece_View$shapeInfo(model.shape);
	var color = _p21.color;
	var realPosition = _lucamug$elm_tangram$Piece_Model$getPosition(model);
	var pos = {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Basics$toFloat(realPosition.x),
	...
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			...
			_0: A2(
				...
				'mousedown',
				A2(_elm_lang$core$Json_Decode$map, _lucamug$elm_tangram$Piece_Types$DragStart, _lucamug$elm_tangram$Piece_View$offsetPosition)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A5(
				_lucamug$elm_tangram$Piece_View$polygon2,
				model,
				_lucamug$elm_tangram$Piece_View$vertices(model),
				color,
				pos,
				model.drag),
			_1: {ctor: '[]'}
...
var _lucamug$elm_tangram$Tangram_Update$bounds = function (model) {
	return A2(
		_lucamug$elm_tangram$Piece_View$boundingBox,
		model.strokeOffset,
		_elm_lang$core$List$concat(
			A2(
				_elm_lang$core$List$map,
				function (_p0) {
					return _lucamug$elm_tangram$Piece_View$vertices(
						_elm_lang$core$Tuple$second(_p0));
				},
				model.pieces)));
};
var _lucamug$elm_tangram$Tangram_Update$moveToPosition = F2(
	function (_p1, model) {
		var _p2 = _p1;
		var _p3 = _lucamug$elm_tangram$Tangram_Update$bounds(model);
		var ox = _p3._0._0;
		var oy = _p3._0._1;
		var vector = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$toFloat(_p2.x) - ox,
			_1: _elm_lang$core$Basics$toFloat(_p2.y) - oy
		};
		var movePiece = function (_p4) {
			var _p5 = _p4;
			return {
				ctor: '_Tuple2',
				_0: _p5._0,
				_1: A2(_lucamug$elm_tangram$Piece_Model$move, vector, _p5._1)
			};
		};
		var pieces = A2(_elm_lang$core$List$map, movePiece, model.pieces);
		return _elm_lang$core$Native_Utils.update(
			model,
			{pieces: pieces});
	});
var _lucamug$elm_tangram$Tangram_Update$moveToOrigin = function (model) {
	return A2(
		_lucamug$elm_tangram$Tangram_Update$moveToPosition,
		{x: 0, y: 0},
		model);
};
var _lucamug$elm_tangram$Tangram_Update$removePiece = F2(
	function (name, items) {
		return A2(
			_elm_lang$core$List$filter,
			function (_p6) {
...
var _lucamug$elm_tangram$Tangram_Update$findPiece = F2(
	function (name, items) {
		return A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$Tuple$second,
...
var _lucamug$elm_tangram$Tangram_Update$bringToTop = F2(
	function (name, items) {
		var pieceMaybe = A2(_lucamug$elm_tangram$Tangram_Update$findPiece, name, items);
		var _p8 = pieceMaybe;
		if (_p8.ctor === 'Just') {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_lucamug$elm_tangram$Tangram_Update$removePiece, name, items),
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: name, _1: _p8._0},
					_1: {ctor: '[]'}
				});
		} else {
			return items;
...
var _lucamug$elm_tangram$Tangram_Update$updatePieces = F4(
		...
		var updatePiece = F2(
			function (_p10, _p9) {
				...
				if (_elm_lang$core$Native_Utils.eq(_p16, name)) {
					var _p13 = A3(_lucamug$elm_tangram$Piece_Update$update, context, msg, _p11._1);
					var piece_ = _p13._0;
					var cmd = _p13._1;
					return {
						ctor: '_Tuple2',
						_0: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _p16, _1: piece_},
							_1: _p15
						},
						_1: {
							ctor: '::',
							_0: A2(
								...
								_lucamug$elm_tangram$Tangram_Types$PieceMsg(name),
								cmd),
							_1: _p14
						}
					};
...
var _lucamug$elm_tangram$Tangram_Update$positionDiff = F2(
	function (origin, pos) {
		return A2(_lucamug$elm_tangram$Tangram_Types$Position, pos.x - origin.x, pos.y - origin.y);
	});
var _lucamug$elm_tangram$Tangram_Update$update = F2(
	function (msg, model) {
		var _p17 = msg;
		switch (_p17.ctor) {
			case 'PieceMsg':
				var _p21 = _p17._1;
				var _p20 = _p17._0;
				var context = {shift: model.keyShiftDown, windowSize: model.windowSize};
				var pathSorted = A2(_lucamug$elm_tangram$Tangram_Model$modelToPathSorted, model, model.pieces);
				var _p18 = A4(_lucamug$elm_tangram$Tangram_Update$updatePieces, _p20, _p21, context, model.pieces);
				var pieces_ = _p18._0;
				var cmds = _p18._1;
				var newPieces = A2(_lucamug$elm_tangram$Tangram_Update$bringToTop, _p20, pieces_);
				var newPathSorted = A2(_lucamug$elm_tangram$Tangram_Model$modelToPathSorted, model, newPieces);
				var newPath = _lucamug$elm_tangram$Tangram_Model$modelToPath(
					_elm_lang$core$Native_Utils.update(
						model,
						{pieces: newPieces}));
				var extraCmd = _elm_lang$core$Native_Utils.eq(pathSorted, newPathSorted) ? _elm_lang$core$Platform_Cmd$none : _elm_lang$navigation$Navigation$newUrl(newPath);
				var pieceDragging = function () {
					var _p19 = _p21;
					switch (_p19.ctor) {
						case 'DragStart':
							return true;
				...
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{pieces: newPieces, pieceDragging: pieceDragging});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					newModel,
					{ctor: '::', _0: extraCmd, _1: cmds});
			case 'WindowSize':
				var _p22 = _p17._0;
				var height = _p22.height;
				var width = _p22.width;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							windowSize: A2(_elm_lang$window$Window$Size, width, height)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyDown':
				var _p23 = _p17._0;
				return _elm_lang$core$Native_Utils.eq(_p23, 16) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{keyShiftDown: true}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : ((_elm_lang$core$Native_Utils.eq(_p23, 91) || _elm_lang$core$Native_Utils.eq(_p23, 224)) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{keyCommandDown: true}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : ((_elm_lang$core$Native_Utils.eq(_p23, 90) && (model.keyCommandDown && model.keyShiftDown)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$forward(1),
						_1: {ctor: '[]'}
					}) : ((_elm_lang$core$Native_Utils.eq(_p23, 90) && model.keyCommandDown) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
			...
			case 'KeyUp':
				var _p24 = _p17._0;
				return _elm_lang$core$Native_Utils.eq(_p24, 16) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{keyShiftDown: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				} : (_elm_lang$core$Native_Utils.eq(_p24, 91) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{keyCommandDown: false}),
			...
			case 'ChangeAspect':
				var structure = _lucamug$elm_tangram$Tangram_Model$modelToStructure(model);
				var conf = _lucamug$elm_tangram$Tangram_Model$confStringToConf(structure.conf);
				var newConf = _elm_lang$core$Native_Utils.update(
					conf,
					{
						...
						canvasColor: function () {
							...
							if (_p27.ctor === 'Just') {
								...
								return conf.canvasColor;
							}
						}(),
						colorCombination: function () {
							var _p28 = _p17._0;
							if (_p28.ctor === 'Just') {
								return _p28._0;
							} else {
								return conf.colorCombination;
							}
						}()
					});
				var newStructure = _elm_lang$core$Native_Utils.update(
					structure,
					{
						conf: _lucamug$elm_tangram$Tangram_Model$confToConfString(newConf)
					});
				var newPath = _lucamug$elm_tangram$Tangram_Model$structureToPath(newStructure);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$newUrl(newPath),
						_1: {ctor: '[]'}
					});
			case 'ChangeLocation':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$navigation$Navigation$newUrl(_p17._0)
				};
			case 'NoOp':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'MoveToOrigin':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_lucamug$elm_tangram$Tangram_Update$moveToOrigin(model),
					{ctor: '[]'});
			case 'RectDragStart':
				var _p29 = _p17._0._1;
				var rectDrag = model.pieceDragging ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
					_lucamug$elm_tangram$Tangram_Types$Dragging(
						{start: _p29, current: _p29}));
				var svgOrigin = A2(_lucamug$elm_tangram$Tangram_Update$positionDiff, _p29, _p17._0._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ChangeLocationAndToggle':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$navigation$Navigation$newUrl(_p17._0),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
...
var _lucamug$elm_tangram$Tangram_View$madeByLucamug = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$class('lucamug'),
		_1: {
			ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$class('lucamugSpin'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _lucamug$elm_tangram$Tangram_View$forkMe = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$href('https://github.com/lucamug/elm-tangram'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _lucamug$elm_tangram$Tangram_View$debugInfo = function (model) {
	return A2(
			...
			_1: {
				...
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'shift = ',
						_elm_lang$core$Basics$toString(model.keyShiftDown))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'shift = ',
							_elm_lang$core$Basics$toString(model.keyControlDown))),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'shift = ',
								_elm_lang$core$Basics$toString(model.keyCommandDown))),
						_1: {
							ctor: '::',
							_0: A2(
								...
								A2(
									...
									_elm_lang$core$List$reverse(model.pieces))),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _lucamug$elm_tangram$Tangram_View$lastMoved = function (listPieces) {
	return A2(
		_elm_lang$core$Maybe$map,
		_elm_lang$core$Basics$identity,
		_elm_lang$core$List$head(
			_elm_lang$core$List$reverse(listPieces)));
};
var _lucamug$elm_tangram$Tangram_View$cursorVal = function (model) {
	return A2(
		_elm_lang$core$List$any,
		function (_p1) {
			return _lucamug$elm_tangram$Piece_Model$rotating(
				_elm_lang$core$Tuple$second(_p1));
		},
		model.pieces) ? 'crosshair' : 'default';
};
var _lucamug$elm_tangram$Tangram_View$pieceView = function (_p2) {
	var _p3 = _p2;
	return A2(
		_elm_lang$html$Html$map,
		_lucamug$elm_tangram$Tangram_Types$PieceMsg(_p3._0),
		_lucamug$elm_tangram$Piece_View$view(_p3._1));
};
var _lucamug$elm_tangram$Tangram_View$offsetPosition = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
	...
	A3(
		_elm_lang$core$Json_Decode$map2,
		_lucamug$elm_tangram$Tangram_Types$Position,
		A2(_elm_lang$core$Json_Decode$field, 'pageX', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode$field, 'pageY', _elm_lang$core$Json_Decode$int)),
	A3(
		_elm_lang$core$Json_Decode$map2,
		...
		A2(_elm_lang$core$Json_Decode$field, 'offsetX', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode$field, 'offsetY', _elm_lang$core$Json_Decode$int)));
var _lucamug$elm_tangram$Tangram_View$margin = 10;
var _lucamug$elm_tangram$Tangram_View$scene = function (model) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{
			ctor: '::',
			_0: A2(
				_elm_lang$virtual_dom$VirtualDom$on,
				'mousedown',
				A2(_elm_lang$core$Json_Decode$map, _lucamug$elm_tangram$Tangram_Types$RectDragStart, _lucamug$elm_tangram$Tangram_View$offsetPosition)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$width(
					_elm_lang$core$Basics$toString(model.windowSize.width - (_lucamug$elm_tangram$Tangram_View$margin * 2))),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$height(
						_elm_lang$core$Basics$toString(model.windowSize.height - (_lucamug$elm_tangram$Tangram_View$margin * 2))),
					_1: {ctor: '[]'}
				}
			}
		},
		A2(
			_elm_lang$core$List$map,
			_elm_lang$svg$Svg_Lazy$lazy(_lucamug$elm_tangram$Tangram_View$pieceView),
			model.pieces));
};
var _lucamug$elm_tangram$Tangram_View$onLinkClickToggle = function (path) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		{stopPropagation: false, preventDefault: true},
		_elm_lang$core$Json_Decode$succeed(
			_lucamug$elm_tangram$Tangram_Types$ChangeLocationAndToggle(path)));
};
var _lucamug$elm_tangram$Tangram_View$viewToggleLink = F2(
	function (url, string) {
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_1: {
					ctor: '::',
					_0: _lucamug$elm_tangram$Tangram_View$onLinkClickToggle(url),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _lucamug$elm_tangram$Tangram_View$onLinkClick = function (path) {
	return A3(
		_elm_lang$html$Html_Events$onWithOptions,
		'click',
		{stopPropagation: false, preventDefault: true},
		_elm_lang$core$Json_Decode$succeed(
			_lucamug$elm_tangram$Tangram_Types$ChangeLocation(path)));
};
var _lucamug$elm_tangram$Tangram_View$viewLink = F2(
	function (url, string) {
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_1: {
					ctor: '::',
					_0: _lucamug$elm_tangram$Tangram_View$onLinkClick(url),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _lucamug$elm_tangram$Tangram_View$view = function (model) {
	var confString = function (_) {
		return _.conf;
	}(
		_lucamug$elm_tangram$Tangram_Model$modelToStructure(model));
	var neutralStart = A2(
		_elm_lang$core$Basics_ops['++'],
		'/☞,',
		A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								',',
								A2(_elm_lang$core$Basics_ops['++'], confString.colorCombination, '_'))))))));
	var canvasColor = _lucamug$elm_tangram$Colors$colorToNakedString(model.canvasColor);
	var baseColor = _lucamug$elm_tangram$Colors$colorToNakedString(_lucamug$elm_tangram$Colors$elmOrange);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Tangram'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_0: {
										...
										_1: A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(_lucamug$elm_tangram$Tangram_View$margin),
											'px')
									},
									_1: {ctor: '[]'}
								}),
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Canvas'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
														...
														_0: A2(
															_elm_lang$html$Html$button,
															{
																...
																_0: _elm_lang$html$Html_Events$onClick(
																	A4(
																		_lucamug$elm_tangram$Tangram_Types$ChangeAspect,
																		_elm_lang$core$Maybe$Nothing,
																		_elm_lang$core$Maybe$Nothing,
																		_elm_lang$core$Maybe$Nothing,
																		_elm_lang$core$Maybe$Just(_lucamug$elm_tangram$Colors$white))),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('White'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
																...
																_elm_lang$html$Html$button,
																{
																	...
																	_0: _elm_lang$html$Html_Events$onClick(
																		A4(
																			...
																			_elm_lang$core$Maybe$Nothing,
																			_elm_lang$core$Maybe$Nothing,
																			_elm_lang$core$Maybe$Just(_lucamug$elm_tangram$Colors$canvasGray))),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Gray'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																	...
																	_elm_lang$html$Html$button,
																	{
																		...
																		_0: _elm_lang$html$Html_Events$onClick(
																			A4(
																				...
																				_elm_lang$core$Maybe$Nothing,
																				_elm_lang$core$Maybe$Nothing,
																				_elm_lang$core$Maybe$Just(_lucamug$elm_tangram$Colors$darkGray))),
																		_1: {ctor: '[]'}
																	},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Dark Gray'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																		...
																		_elm_lang$html$Html$button,
																		{
																			...
																			_0: _elm_lang$html$Html_Events$onClick(
																				A4(
																					...
																					_elm_lang$core$Maybe$Nothing,
																					_elm_lang$core$Maybe$Nothing,
																					_elm_lang$core$Maybe$Just(_elm_lang$core$Color$orange))),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Orange'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Border'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
																		...
																		_elm_lang$html$Html$button,
																		{
																			...
																			_0: _elm_lang$html$Html_Events$onClick(
																				A4(
																					...
																					_elm_lang$core$Maybe$Nothing,
																					_elm_lang$core$Maybe$Nothing,
																					_elm_lang$core$Maybe$Just(_lucamug$elm_tangram$Colors$elmOrange),
																					_elm_lang$core$Maybe$Nothing)),
																			_1: {ctor: '[]'}
																		},
																		{
																			...
																			_elm_lang$html$Html$button,
																			{
																				...
																				_0: _elm_lang$html$Html_Events$onClick(
																					A4(
																						...
																						_elm_lang$core$Maybe$Nothing,
																						_elm_lang$core$Maybe$Nothing,
																						_elm_lang$core$Maybe$Just(model.canvasColor),
																						_elm_lang$core$Maybe$Nothing)),
																				_1: {ctor: '[]'}
																			},
																			{
																	...
																	_0: A2(
																		_elm_lang$html$Html$button,
																		{
																			...
																			_0: _elm_lang$html$Html_Events$onClick(
																				A4(
																					_lucamug$elm_tangram$Tangram_Types$ChangeAspect,
																					_elm_lang$core$Maybe$Just(_lucamug$elm_tangram$Tangram_Types$Elm),
																					_elm_lang$core$Maybe$Nothing,
																					_elm_lang$core$Maybe$Nothing,
																					_elm_lang$core$Maybe$Nothing)),
																			_1: {ctor: '[]'}
																		...
																		_0: A2(
																			_elm_lang$html$Html$button,
																			{
																				...
																				_0: _elm_lang$html$Html_Events$onClick(
																					A4(
																						_lucamug$elm_tangram$Tangram_Types$ChangeAspect,
																						_elm_lang$core$Maybe$Just(_lucamug$elm_tangram$Tangram_Types$Rainbow),
																						_elm_lang$core$Maybe$Nothing,
																						_elm_lang$core$Maybe$Nothing,
																						_elm_lang$core$Maybe$Nothing)),
																				_1: {ctor: '[]'}
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Rainbow 🌈'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																				...
																				_elm_lang$html$Html$button,
																				{
																					...
																					_0: _elm_lang$html$Html_Events$onClick(
																						A4(
																							_lucamug$elm_tangram$Tangram_Types$ChangeAspect,
																							_elm_lang$core$Maybe$Just(
																								_lucamug$elm_tangram$Tangram_Types$Color(_lucamug$elm_tangram$Colors$darkGray)),
																							_elm_lang$core$Maybe$Nothing,
																							_elm_lang$core$Maybe$Nothing,
																							_elm_lang$core$Maybe$Nothing)),
																					_1: {ctor: '[]'}
																					...
																					_elm_lang$html$Html$button,
																					{
																						...
																						_0: _elm_lang$html$Html_Events$onClick(
																							A4(
																								_lucamug$elm_tangram$Tangram_Types$ChangeAspect,
																								_elm_lang$core$Maybe$Just(
																									_lucamug$elm_tangram$Tangram_Types$Color(_lucamug$elm_tangram$Colors$elmOrange)),
																								_elm_lang$core$Maybe$Nothing,
																								_elm_lang$core$Maybe$Nothing,
																								_elm_lang$core$Maybe$Nothing)),
																						_1: {ctor: '[]'}
																						...
																						_elm_lang$html$Html$button,
																						{
																							...
																							_0: _elm_lang$html$Html_Events$onClick(
																								A4(
																									_lucamug$elm_tangram$Tangram_Types$ChangeAspect,
																									_elm_lang$core$Maybe$Just(
																										_lucamug$elm_tangram$Tangram_Types$Color(_lucamug$elm_tangram$Colors$black)),
																									_elm_lang$core$Maybe$Nothing,
																									_elm_lang$core$Maybe$Nothing,
																									_elm_lang$core$Maybe$Nothing)),
																							_1: {ctor: '[]'}
															...
															_1: {
																...
																_0: A2(
																	...
																	{ctor: '[]'},
																	{
																		ctor: '::',
																		_0: A2(
																			_lucamug$elm_tangram$Tangram_View$viewLink,
																			A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▢,250,200,180_▱,175,125,180_△,200,250,0_▷,150,200,90_▽,200,175,180_◁,275,250,270_◹,275,125,45'),
																			'Square 1'),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				_lucamug$elm_tangram$Tangram_View$viewLink,
																				A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▢,200,150,180_▰,275,225,90_△,200,250,0_▷,150,200,90_▽,150,125,180_◁,225,200,270_◹,275,125,45'),
																				'Square 2'),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					_lucamug$elm_tangram$Tangram_View$viewLink,
																					A2(_elm_lang$core$Basics_ops['++'], neutralStart, '△,184,271,180_◹,109,296,225_▽,234,296,0_◁,259,271,270_▷,152,171,0_▢,217,116,135_▰,252,186,45'),
																					'House'),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						_lucamug$elm_tangram$Tangram_View$viewLink,
																						A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▷,115,178,315_◁,241,160,315_◹,259,213,270_▽,269,284,90_▱,150,249,135_△,187,92,0_▢,115,320,135'),
																						'A'),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							_lucamug$elm_tangram$Tangram_View$viewLink,
																							A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▷,113,78,315_△,111,288,226_◹,113,184,270_▢,183,183,135_▽,243,184,90_◁,243,84,90_▱,243,259,90'),
																							'B'),
																						_1: {
																							ctor: '::',
																							_0: A2(
																								_lucamug$elm_tangram$Tangram_View$viewLink,
																								A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▷,128,182,270_△,113,287,225_▽,203,132,90_◹,149,356,180_▱,219,357,135_▢,253,286,135_◁,232,100,45'),
																								'C'),
																							_1: {ctor: '[]'}
																						}
																					}
														...
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Paradoxes'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{ctor: '[]'},
																		{
																			...
																			_0: _elm_lang$core$Native_Utils.eq(
																				A2(_elm_lang$core$Basics_ops['%'], model.counter, 2),
																				0) ? A2(
																				_lucamug$elm_tangram$Tangram_View$viewToggleLink,
																				A2(_elm_lang$core$Basics_ops['++'], neutralStart, '◁,219,35,0_▢,219,95,135_△,169,231,270_▰,94,206,0_▷,169,331,90_◹,194,406,135_▽,94,280,270'),
																				'Monk 1 ⥁') : A2(
																				_lucamug$elm_tangram$Tangram_View$viewToggleLink,
																				A2(_elm_lang$core$Basics_ops['++'], neutralStart, '◁,219,35,0_▢,219,95,135_▷,184,236,135_△,184,306,45_▰,94,206,0_◹,144,386,225_▽,159,464,135'),
																				'Monk 2 ⥁'),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$core$Native_Utils.eq(
																					A2(_elm_lang$core$Basics_ops['%'], model.counter, 3),
																					1) ? A2(
																					_lucamug$elm_tangram$Tangram_View$viewToggleLink,
																					A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▷,199,57,315_◹,188,188,135_◁,238,163,90_▱,188,238,0_▢,113,163,0_△,128,57,45_▽,113,238,0'),
																					'Cup 1 ⥁') : (_elm_lang$core$Native_Utils.eq(
																					A2(_elm_lang$core$Basics_ops['%'], model.counter, 3),
																					2) ? A2(
																					_lucamug$elm_tangram$Tangram_View$viewToggleLink,
																					A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▷,199,57,315_◁,238,163,90_▢,113,163,0_△,128,57,45_▽,188,164,270_◹,198,235,0_▱,127,235,135'),
																					'Cup 2 ⥁') : A2(
																					_lucamug$elm_tangram$Tangram_View$viewToggleLink,
																					A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▱,96,46,180_▽,121,96,180_▷,171,121,270_◹,246,46,315_◁,246,171,90_▢,121,171,0_△,171,221,0'),
																					'Cup 3 ⥁')),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$core$Native_Utils.eq(
																						...
																						0) ? A2(
																						_lucamug$elm_tangram$Tangram_View$viewToggleLink,
																						A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▢,69,68,225_▱,140,103,225_▷,281,138,135_◹,200,98,315_△,352,138,225_▽,635,148,0_◁,521,148,0'),
																						'Loch Ness 1 ⥁') : A2(
																						_lucamug$elm_tangram$Tangram_View$viewToggleLink,
																						A2(_elm_lang$core$Basics_ops['++'], neutralStart, '▢,69,68,225_▱,140,103,225_◹,200,148,225_▷,275,123,180_△,375,123,0_◁,538,148,0_▽,325,48,0'),
																						'Loch Ness 2 ⥁'),
																					_1: {ctor: '[]'}
																				}
																			}
																		...
																		_0: A2(
																			...
																			{ctor: '[]'},
																			{
																				...
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html_Events$onClick(_lucamug$elm_tangram$Tangram_Types$Back),
																						_1: {ctor: '[]'}
																					},
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('↺ Undo ⌘Z'),
																						_1: {ctor: '[]'}
																					}),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html_Events$onClick(_lucamug$elm_tangram$Tangram_Types$Forward),
																							_1: {ctor: '[]'}
																						},
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html$text('↻ Redo ⇧⌘Z'),
																							_1: {ctor: '[]'}
																						}),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onClick(_lucamug$elm_tangram$Tangram_Types$MoveToOrigin),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('Move Up Left'),
																								_1: {ctor: '[]'}
																							}),
																						_1: {ctor: '[]'}
																					}
						...
						_0: A2(
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'background-color',
												_1: _lucamug$elm_tangram$Colors$colorToString(model.canvasColor)
											},
											_1: {
												ctor: '::',
												_0: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: 'inset rgba(0, 0, 0, 0.067) 0 0 20px 4px'},
														_1: {
															ctor: '::',
							...
							},
							{
								...
								_0: A2(
													...
													_1: {
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'opacity', _1: '0.2'},
																	_1: {
																		ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Drag = Move'),
										_1: {
											ctor: '::',
											_0: A2(
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text('Shift-Drag = Rotate'),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$br,
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text('⌘Z = Undo'),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$br,
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text('⇧⌘Z = Redo'),
																_1: {ctor: '[]'}
															}
														}
													}
								...
								_1: {
									ctor: '::',
									_0: _lucamug$elm_tangram$Tangram_View$scene(model),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$class('footerContainer'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _lucamug$elm_tangram$Tangram_View$madeByLucamug,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _lucamug$elm_tangram$Tangram_View$forkMe,
								_1: {ctor: '[]'}
							}
						}
					}
...
var _lucamug$elm_tangram$Editor$init = function (tangram) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			tangram: tangram,
...
var _lucamug$elm_tangram$Editor$Model = F2(
	function (a, b) {
		return {tangram: a, pointer: b};
	});
var _lucamug$elm_tangram$Editor$MousePos = function (a) {
	return {ctor: 'MousePos', _0: a};
};
var _lucamug$elm_tangram$Editor$TangramMsg = function (a) {
	return {ctor: 'TangramMsg', _0: a};
};
var _lucamug$elm_tangram$Editor$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'TangramMsg') {
			var _p1 = A2(_lucamug$elm_tangram$Tangram_Update$update, _p0._0, model.tangram);
			var tmodel = _p1._0;
			var tcmd = _p1._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _lucamug$elm_tangram$Editor$TangramMsg, tcmd),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
...
var _lucamug$elm_tangram$Editor$view = function (model) {
	return A2(
		_elm_lang$html$Html$map,
		_lucamug$elm_tangram$Editor$TangramMsg,
		_lucamug$elm_tangram$Tangram_View$view(model.tangram));
};
var _lucamug$elm_tangram$Editor$subscriptions = function (model) {
	return A2(
		_elm_lang$core$Platform_Sub$map,
		_lucamug$elm_tangram$Editor$TangramMsg,
		_lucamug$elm_tangram$Tangram_Model$subscriptions(model.tangram));
};

var _lucamug$elm_tangram$Main$cleanPath = function (path) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		_elm_lang$http$Http$decodeUri(
			A2(_elm_lang$core$String$dropLeft, 1, path)));
};
var _lucamug$elm_tangram$Main$Model = F2(
	function (a, b) {
		return {tangram: a, editor: b};
	});
var _lucamug$elm_tangram$Main$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _lucamug$elm_tangram$Main$EditorMsg = function (a) {
	return {ctor: 'EditorMsg', _0: a};
};
var _lucamug$elm_tangram$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$map,
		_lucamug$elm_tangram$Main$EditorMsg,
		_lucamug$elm_tangram$Editor$view(model.editor));
};
var _lucamug$elm_tangram$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$core$Platform_Sub$map,
				_lucamug$elm_tangram$Main$EditorMsg,
				_lucamug$elm_tangram$Editor$subscriptions(model.editor)),
			_1: {ctor: '[]'}
		});
};
var _lucamug$elm_tangram$Main$TangramMsg = function (a) {
	return {ctor: 'TangramMsg', _0: a};
};
var _lucamug$elm_tangram$Main$init = F2(
	function (val, location) {
		var tempPath = _lucamug$elm_tangram$Main$cleanPath(location.pathname);
		var path = _elm_lang$core$Native_Utils.eq(tempPath, '') ? _lucamug$elm_tangram$Tangram_Model$startingPath : tempPath;
		var _p0 = _lucamug$elm_tangram$Tangram_Model$init(path);
		var tmodel = _p0._0;
		var tcmd = _p0._1;
		var _p1 = _lucamug$elm_tangram$Tangram_Model$init(path);
		var etangram = _p1._0;
		var ecmd = _p1._1;
		var _p2 = _lucamug$elm_tangram$Editor$init(etangram);
		var editorModel = _p2._0;
		var editorCmd = _p2._1;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{tangram: tmodel, editor: editorModel},
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _lucamug$elm_tangram$Main$TangramMsg, tcmd),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Platform_Cmd$map,
						function (_p3) {
							return _lucamug$elm_tangram$Main$EditorMsg(
								_lucamug$elm_tangram$Editor$TangramMsg(_p3));
						},
						ecmd),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _lucamug$elm_tangram$Main$EditorMsg, editorCmd),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _lucamug$elm_tangram$Main$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'TangramMsg':
				var _p5 = A2(_lucamug$elm_tangram$Tangram_Update$update, _p4._0, model.tangram);
				var tmodel = _p5._0;
				var tcmd = _p5._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'EditorMsg':
				var _p6 = A2(_lucamug$elm_tangram$Editor$update, _p4._0, model.editor);
				var emodel = _p6._0;
				var ecmd = _p6._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Platform_Cmd$map, _lucamug$elm_tangram$Main$EditorMsg, ecmd),
						_1: {ctor: '[]'}
					});
			default:
				var editor = model.editor;
				var tangramModel = editor.tangram;
				var newPath = _lucamug$elm_tangram$Main$cleanPath(_p4._0.pathname);
				var newConf = _lucamug$elm_tangram$Tangram_Model$pathToConf(newPath);
				var newPieces = _lucamug$elm_tangram$Tangram_Model$pathToPieces(newPath);
				var newTangramModel = _elm_lang$core$Native_Utils.update(
					tangramModel,
					{pieces: newPieces, strokeOffset: newConf.strokeOffset, strokeColor: newConf.strokeColor, canvasColor: newConf.canvasColor, colorCombination: newConf.colorCombination});
				var newEditor = _elm_lang$core$Native_Utils.update(
					editor,
					{tangram: newTangramModel});
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _lucamug$elm_tangram$Main$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_lucamug$elm_tangram$Main$UrlChange,
	{init: _lucamug$elm_tangram$Main$init, view: _lucamug$elm_tangram$Main$view, update: _lucamug$elm_tangram$Main$update, subscriptions: _lucamug$elm_tangram$Main$subscriptions})(_elm_lang$core$Json_Decode$string);

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _lucamug$elm_tangram$Main$main !== 'undefined') {
    _lucamug$elm_tangram$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Tangram.Types.Msg":{"args":[],"tags":{"ChangeLocationAndToggle":["String"],"RectDragAt":["Tangram.Types.Position"],"MousePos":["( Mouse.Position, Mouse.Position )"],"RectDragStart":["( Tangram.Types.Position, Tangram.Types.Position )"],"Forward":[],"PieceMsg":["Tangram.Types.Name","Piece.Types.Msg"],"ChangeAspect":["Maybe.Maybe Tangram.Types.ColorCombination","Maybe.Maybe Float","Maybe.Maybe Colors.Color","Maybe.Maybe Colors.Color"],"MoveToOrigin":[],"WindowSize":["Window.Size"],"RectDragEnd":["Tangram.Types.Position"],"KeyUp":["Char.KeyCode"],"KeyDown":["Char.KeyCode"],"ChangeLocation":["String"],"Back":[],"NoOp":[]}},"Piece.Types.Msg":{"args":[],"tags":{"DragEnd":["Piece.Types.Position"],"DragAt":["Piece.Types.Position"],"DragStart":["( Piece.Types.Position, Piece.Types.Position )"]}},"Color.Color":{"args":[],"tags":{"HSLA":["Float","Float","Float","Float"],"RGBA":["Int","Int","Int","Float"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"EditorMsg":["Editor.Msg"],"TangramMsg":["Tangram.Types.Msg"],"UrlChange":["Navigation.Location"]}},"Tangram.Types.ColorCombination":{"args":[],"tags":{"Color":["Colors.Color"],"Rainbow":[],"Elm":[]}},"Editor.Msg":{"args":[],"tags":{"MousePos":["( Mouse.Position, Mouse.Position )"],"TangramMsg":["Tangram.Types.Msg"]}}},"aliases":{"Char.KeyCode":{"args":[],"type":"Int"},"Piece.Types.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Tangram.Types.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Window.Size":{"args":[],"type":"{ width : Int, height : Int }"},"Colors.Color":{"args":[],"type":"Color.Color"},"Tangram.Types.Name":{"args":[],"type":"String"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
